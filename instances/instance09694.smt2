...
; <!--[\w\W]*?-->
(assert (str.in_re X (re.++ (str.to_re "<!--") (re.* (re.union (re.comp (re.union (re.range "0" "9") (re.range "A" "Z") (re.range "a" "z") (str.to_re "_"))) (re.range "0" "9") (re.range "A" "Z") (re.range "a" "z") (str.to_re "_"))) (str.to_re "-->\u{a}"))))
; [0-9]{4}-[0-9]{3}
