...
(assert (str.in_re X (re.++ (re.+ (re.union (re.range "a" "z") (re.range "A" "Z") (re.range "0" "9") (str.to_re "_") (str.to_re "\u{5c}") (str.to_re "-"))) (str.to_re "@") (re.+ (re.++ (re.+ (re.union (re.range "a" "z") (re.range "A" "Z") (re.range "0" "9") (str.to_re "_") (str.to_re "\u{5c}") (str.to_re "-"))) (str.to_re "\u{5c}") re.allchar)) (str.to_re "com\u{a}"))))
; ^\+[0-9]{1,3}\([0-9]{3}\)[0-9]{7}$
