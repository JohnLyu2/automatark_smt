...
(assert (str.in_re X (re.union (re.++ (str.to_re "4") ((_ re.loop 12 12) (re.range "0" "9"))) (re.++ (str.to_re "4") (re.range "0" "8") ((_ re.loop 14 14) (re.range "0" "9"))) (re.++ (str.to_re "49") (re.union (str.to_re "0") (str.to_re "1") (str.to_re "3")) ((_ re.loop 13 13) (re.range "0" "9"))) (re.++ (str.to_re "49030") (re.range "0" "1") ((_ re.loop 10 10) (re.range "0" "9"))) (re.++ (str.to_re "49033") (re.range "0" "4") ((_ re.loop 10 10) (re.range "0" "9"))) (re.++ (str.to_re "49110") (re.union (str.to_re "1") (str.to_re "2")) ((_ re.loop 10 10) (re.range "0" "9"))) (re.++ (str.to_re "49117") (re.range "0" "3") ((_ re.loop 10 10) (re.range "0" "9"))) (re.++ (str.to_re "49118") (re.range "0" "2") ((_ re.loop 10 10) (re.range "0" "9"))) (re.++ (str.to_re "\u{a}493") (re.comp (str.to_re "6")) ((_ re.loop 12 12) (re.range "0" "9"))))))
; ^([0-9a-fA-F])*$
