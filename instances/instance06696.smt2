...
(assert (not (str.in_re X (re.++ (re.union (re.range "0" "9") (re.++ (re.range "0" "1") (re.range "0" "9")) (re.++ (str.to_re "2") (re.range "0" "3"))) (re.opt (str.to_re ":")) (str.to_re "\u{a}") (re.range "0" "5") (re.range "0" "9")))))
; /filename=[^\n]*\x2edcr/i
