...
(assert (str.in_re X (re.++ ((_ re.loop 2 2) (re.union (str.to_re "5") (str.to_re "1") (str.to_re "|") (str.to_re "2") (str.to_re "3") (str.to_re "4"))) ((_ re.loop 14 14) (re.range "0" "9")) (str.to_re "\u{a}"))))
